...
export default function HeroSlider(data) {
    return (
        <>
            ...
            <div className='hidden px-8 mt-4 mb-14 max-w-[1440px] m-auto md:block lg:flex xl:px-12 xl:mb-[10rem]'>
                <div className="flex">
                    <div className="relative w-[300px] h-[450px] lg:w-[250px] lg:h-[403px] xl:w-[330px] xl:h-[482px]">
                        <Image src="/images/slider/heroSliderSecond.jpeg" alt="me" objectFit="cover" layout="fill"/>
                    </div>
                    <div className="ml-4 flex flex-col justify-between xl:ml-6">
                        <div className="relative w-[300px] h-[200px] lg:w-[330px] lg:h-[230px] xl:w-[390px] xl:h-[260px]">
                            <Image src="/images/slider/heroSliderFirst.jpeg" alt="me" objectFit="cover" layout="fill"/>
                        </div>
                ...
                <div className="flex flex-col mt-4 lg:mt-0 lg:ml-4 xl:ml-6">
                    <div className="relative w-[466px] h-[310px] mr-3 lg:w-[330px] lg:h-[230px] xl:w-[420px] xl:h-[260px]">
                        <Image src="/images/slider/heroSliderConcert.jpg" alt="me" objectFit="cover" layout="fill"/>
                    </div>
                    <div className="flex mt-4 xl:mt-6">
                        <div className="relative w-[225px] h-[225px] mr-4 lg:w-[157px] lg:h-[157px] xl:w-[198px] xl:h-[198px] xl:mr-6">
                            <Image src="/images/slider/heroSliderThird.jpg" alt="me" objectFit="cover" layout="fill"/>
                        </div>
                        <div className="relative w-[225px] h-[225px] lg:w-[157px] lg:h-[157px] xl:w-[198px] xl:h-[198px]">
                            <Image src="/images/slider/heroSliderFourth.jpg" alt="me" objectFit="cover" layout="fill"/>
                        </div>
