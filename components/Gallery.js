    ...
    <>
      <div>
          ...
          <div className="relative max-w-[1440px] flex flex-col justify-start -mt-4 p-6 md:flex-row md:pt-8 md:pb-4 md:px-0 md:-mt-8 lg:-mt-9 lg:pt-9 lg:pb-5 xl:mx-auto xl:pt-6 xl:mb-2 xl:-mt-6">
            ...
            <div className="mt-1 md:my-auto md:ml-8">
              <div
                className={`${
                  active == "all"
                    ? "text-grey lg:text-black anim_underline anim_underline_active"
                    : "text-black anim_underline"
                } linkGallery pb-1 inline cursor-pointer`}
                onClick={() => {
                  setActive("all"), setItems(images), top();
                }}
              >
                All
              </div>
              <div
                className={`${
                  active == "wedding"
                    ? "text-grey lg:text-black anim_underline anim_underline_active"
                    : "text-black anim_underline"
                } linkGallery pb-1 inline cursor-pointer mx-4 md:mx-6`}
                onClick={() => {
                  setActive("wedding"), filterItem("wedding");
                }}
              >
                Weddings
              </div>
              <div
                ...
                onClick={() => {
                  setActive("portrait"), filterItem("portrait");
                }}
              >
                Portraits
              </div>
              <div
                ...
                onClick={() => {
                  setActive("event"), filterItem("event");
                }}
              >
                Events
              </div>
              <div
                ...
                onClick={() => {
                  setActive("concert"), filterItem("concert");
                }}
              >
                Concerts
              </div>
        ...
        <div
          className={`${
            modal
              ? "flex w-screen h-screen fixed top-0 left-0 justify-center items-center bg-white z-[200]"
              : "hidden"
          }`}
        >
          <div>
            <div
              onClick={prevSlide}
              className="select-none absolute cursor-pointer top-[50%] left-8 z-10"
            >
              <svg
                width="12"
                height="17"
              ...
              >
                <rect
                  ...
                  height="3"
                  rx="1"
                  transform="rotate(-135.677 9.02148 16.9694)"
                  fill="black"
                />
                <rect
                  x="0.4375"
                  ...
                  height="3"
                  rx="1"
                  transform="rotate(-45.6767 0.4375 8.5849)"
                  fill="black"
                />
              </svg>
            </div>
            <div
              onClick={nextSlide}
              className="select-none absolute cursor-pointer top-[50%] right-8 z-10"
            >
              <svg
                width="11"
                height="17"
              ...
              >
                <rect
                  ...
                  height="3"
                  rx="1"
                  transform="rotate(44.3233 2.0957 0)"
                  fill="black"
                />
                <rect
                  x="10.6797"
                  ...
                  height="3"
                  rx="1"
                  transform="rotate(134.323 10.6797 8.38446)"
                  fill="black"
                />
              </svg>
            </div>
          ...
          <Image
            className="object-contain m-auto !w-[75%] !h-[75%] max-w-[1512px]"
          ...
          />
          <div
            className="close-btn fixed z-[201] select-none w-auto right-8 top-9 md:top-8 cursor-pointer"
            onClick={() => {
              setModal(false);
            }}
          >
            ...
            >
              <rect
                ...
                height="3"
                rx="1"
                transform="rotate(44.3233 3.03711 1.09048)"
                fill="black"
              />
              <rect
                x="15.9629"
                ...
                height="3"
                rx="1"
                transform="rotate(-135.677 15.9629 17.9095)"
                fill="black"
              />
              <rect
                x="11.6211"
                ...
                height="3"
                rx="1"
                transform="rotate(134.323 11.6211 9.47495)"
                fill="black"
              />
              <rect
                x="7.37891"
                ...
                height="3"
                rx="1"
                transform="rotate(-45.6767 7.37891 9.52505)"
                fill="black"
              />
            </svg>
          </div>
        ...
        <div className="columns-1 md:columns-2 md:mb-4 lg:columns-3">
          {items.map((item, index) => {
            ...
            return (
              <div>
                <div
                  className="transition-all duration-300 ease-in-out h-full w-full mb-4 cursor-pointer hover:opacity-80"
