      ...
      <div className="w-full fixed z-50 left-0 top-0">
          <nav className="bg-transparent flex justify-between items-center pl-3 pr-6 h-[90px] md:px-7 xl:h-[150px] xl:px-12">
              <div className="nav-logo flex items-center justify-start md:justify-center md:w-1/6 xl:w-1/5">
                <div className="relative w-[7rem] h-[7rem] md:w-24 md:h-20 xl:w-40 xl:h-32">
                  <Link href="/">
          ...
          <div className={`mobile-menu ${menuOpen ? 'translate-x-0' : 'translate-x-full'} transition-all w-screen h-screen-safe absolute top-0 left-0 z-50 dark:bg-black dark:text-white md:hidden`}>
            ...
            <div className='close-btn absolute w-auto right-6 top-6 cursor-pointer' onClick={menuToggle}>
