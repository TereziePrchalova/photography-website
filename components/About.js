            ...
            <div className=''>
                ...
                <div className="px-6 md:pl-8">
                    <div className="flex mt-4 mb-6">
                        <div className="relative w-[140px] h-[140px] mr-3 md:mr-4 md:w-[225px] md:h-[225px]">
                            <Image src="/images/first.jpg" alt="me" objectFit="cover" layout="fill"/>
                        </div>
                        <div className="relative w-[140px] h-[140px] md:w-[225px] md:h-[225px]">
                    ...
                    <div className="w-[300px] md:w-[400px]">
                        ...
                        <p className="p">The beginnings were interesting, I tried to do my best, but not always succeeded. I've learned a lot along the way and a moment later, I started photographing weddings, concerts and people in general and I found myself in photographing emotions. I'm also interested in building websites and travelling.</p>
                    </div>
                </div>
            </div>
        </>
