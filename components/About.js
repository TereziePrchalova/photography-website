    ...
    return (
        <>
            <div className='max-w-[1440px] m-auto'>
                ...
                <div className="my-6 md:flex md:mx-auto md:w-[696px] lg:w-[942px] lg:flex lg:my-10 ">
                    <div className="flex justify-center mt-1 mb-6 md:my-0 md:flex md:flex-col ">
                        <div className="relative w-[157px] h-[157px] mr-4 md:mb-4 lg:mr-4 ">
                    ...
                    <div className="m-auto w-[320px] md:w-[400px] md:mt-0 md:mx-0 lg:w-[420px] xl:ml-6">
